...
export default function Form() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      <h2 className="text-2xl font-semibold text-gray-800 mb-4"> {taskId ? "Editar Tarefa" : "Criar Sessao"} </h2>
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          <label htmlFor="title" className="block text-sm font-medium text-gray-700">Filme</label>
          <input
            type="text"
            id="title"
            name="title"
        ...
        <div>
          <label htmlFor="dayOfWeek" className="block text-sm font-medium text-gray-700">Dia da Semana</label>
          <input
            type="text"
            id="dayOfWeek"
            name="dayOfWeek"
        ...
        <div>
          <label htmlFor="user" className="block text-sm font-medium text-gray-700">Horário</label>
          <select
            id="user"
            name="user"
            value={selectedUser}
